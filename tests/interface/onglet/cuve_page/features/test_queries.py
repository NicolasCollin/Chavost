...
class TestQueries(unittest.TestCase):
    ...
    def test_query_kpis_produits(self) -> None:
        ...
        self.assertTrue(
            {"nb_mouvements", "nb_cuvees", "quantite_vendue", "valeur_ventes"}.issubset(
                df.columns
            )
        )
    ...
    def test_query_evolution_mensuelle(self) -> None:
        ...
        self.assertTrue(
            {"mois", "quantite_vendue", "valeur_ventes"}.issubset(df.columns)
        )
    ...
    def test_query_abc(self) -> None:
        ...
        self.assertTrue(
            set(df["classe_abc"].unique().tolist()).issubset({"A", "B", "C"})
        )
